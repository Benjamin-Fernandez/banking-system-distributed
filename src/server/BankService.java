...
public class BankService {
   ...
   public ServiceResult deposit(String holderName, int accountNumber, String password, float amount) {
       BankAccount account = accounts.get(accountNumber);
       if (account == null) {
       ...
       System.out.println("[BankService] Deposited " + amount + " to account #" + accountNumber +
   ...
   public ServiceResult withdraw(String holderName, int accountNumber, String password, float amount) {
       BankAccount account = accounts.get(accountNumber);
       if (account == null) {
           return new ServiceResult(StatusCode.ERROR_ACCOUNT_NOT_FOUND, "Account not found");
       }
       ...
       System.out.println("[BankService] Withdrew " + amount + " from account #" + accountNumber +
                         ". New balance: " + account.getBalance());
